            ...
            <div class="plan__elem">
               ...
               <ul class="plan__list">
                  ...
                  <li class="plan__item">
                    <img src="{{ ('images/right.jpg.png') }}" alt="logo">
                     <p>
                        Словарик в каждом разделе курса позволяет быстро усвоить специфическую артиллерийскую терминологию.
                     </p>
                  </li>
                  <li class="plan__item">
                   <img src="{{ ('images/right.jpg.png') }}" alt="logo">
            ...
            <div class="plan__elem">
               ...
               <ul class="plan__list">
                  ...
                  <li class="plan__item">
                    <img src="{{ ('images/right.jpg.png') }}" alt="logo">
                     <p>
                        В целом пособие позволяет достаточно просто и быстро освоить метод расчетов и наводки.
                     </p>
                  </li>
                  <li class="plan__item">
                    <img src="{{ ('images/right.jpg.png') }}" alt="logo">
                     <p>
                        Новаторская схема позволяет детально изучить алгоритм управления ракетным комплексом. На практике это поможет в борьбе с угрозаами и защите нашей Родины.
                     </p>
                  </li>
               </ul>
            </div>
